...
const Guidelines = () => {
  return (
    <section className='relative flex flex-col items-center text-center pb-16 border-b border-gray-700 lg:grid lg:grid-cols-2 lg:px-20 lg:text-left xl:px-32 2xl:px-40'>
      ...
      <img src={screen.width < 1024 ? lensFlareMobile : lensFlare} alt="Background Image" className='mask-mobile mix-blend-hard-light rotate-180 absolute bottom-0 right-0 w-full h-auto -z-[10] sm:-bottom-36 lg:mask-desktop lg:w-4/5 lg:-right-16' />
