...
const Guidelines = () => {
  return (
    <section className='relative flex flex-col items-center text-center pb-16 border-b border-gray-700 lg:grid lg:grid-cols-2 lg:px-20 lg:text-left xl:px-32 2xl:px-40'>
        <div className='absolute -top-64 left-0 w-full h-full -z-[1] bg-[url(./src/assets/images/purple-lens-flare.png)] bg-center bg-cover mix-blend-hard-light'></div>
        <div className='absolute -bottom-16 right-0 w-full h-full -z-[1] bg-[url(./src/assets/images/purple-lens-flare.png)] bg-center bg-cover mix-blend-hard-light rotate-180 sm:-bottom-28'></div>

        <img src={rulesImg} alt="Rules and Guidelines" className='lg:order-1 lg:justify-self-center' />
